...
export function ReportFilters({
  ...
  return (
    <div className="sticky top-16 z-40 bg-[var(--bg-main)]/95 backdrop-blur-sm py-3 -mx-4 px-4 md:mx-0 md:px-0 border-b border-[var(--border-soft)] md:border-none">
      <div className="flex items-center gap-3">
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 md:pb-0 scrollbar-hide flex-1">
          <select
            ...
            className={`
              ...
              cursor-pointer min-w-[130px] transition-colors
              ${selectedHazard !== 'all' 
        ...
        {hasActiveFilters && (
          <button
            ...
            className="shrink-0 px-3 py-2 text-sm text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors flex items-center gap-1"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
